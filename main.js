...
// Build the WhatsApp "Hire Me" link from the data-whatsapp / data-message
// attributes set on the button in index.html. Edit those attributes, not this code.
document.addEventListener("DOMContentLoaded", () => {
  const hireBtn = document.getElementById("hireMeBtn");
  if (hireBtn) {
    const number = hireBtn.getAttribute("data-whatsapp");
    const message = hireBtn.getAttribute("data-message") || "";
    hireBtn.href = `https://wa.me/${number}?text=${encodeURIComponent(message)}`;
  }
});
